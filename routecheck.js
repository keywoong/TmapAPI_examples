    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function initTmap() {
                ...
                marker_sPosition = new Tmapv2.LatLng(37.566567545861645,
                        126.9850380932383);
                ...
                marker_ePosition = new Tmapv2.LatLng(37.403049076341794,
                        127.10331814639885);
                ...
                marker_s.addListener("dragend",
                        ...
                        var markerLatLng = e.latLng;//이벤트한 값의 
                ...
                $("#btn_select")
                        .click(
                                function () {
                                    ...
                                    console.log("1");
                                    console.log(marker_sPosition.lng());
                                    console.log(marker_sPosition.lat());
                                    
                                    console.log(marker_ePosition.lat());
                                    console.log(marker_ePosition.lng());
                                                ...
                                                success : function(response) {
                                                    ...
                                                    if (trafficInfochk == "Y") {
                                                        ...
                                                        for ( var i in resultData) { //for문 [S]
                                                            var geometry = resultData[i].geometry;//coordinates, traffic, type
                                                            var properties = resultData[i].properties;//description, distance, facilityType, index, lineIndex,name, roadType, time
...
출처: https://newindow.tistory.com/130?category=1169059 [글쓰는 공대생의 블로그]